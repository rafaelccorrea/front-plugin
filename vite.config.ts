...
/** Injeta script Umami apenas quando VITE_ANALYTICS_ENDPOINT e VITE_ANALYTICS_WEBSITE_ID estão definidos */
function vitePluginAnalytics(envDir: string): Plugin {
  return {
...
const plugins = [react(), tailwindcss(), vitePluginManusRuntime(), vitePluginAnalytics(envDir), vitePluginManusDebugCollector()];
